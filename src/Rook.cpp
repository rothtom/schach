...
std::vector<std::unique_ptr<chess::Move>> chess::Rook::get_possible_moves() {
...
std::unique_ptr<chess::Piece> chess::Rook::deep_copy(Board& board) {
    std::unique_ptr<Rook> copy = std::make_unique<Rook>(*this);
